    ...
    try:
        ...
        if preg <= 5:
            ...
            messagebox.showwarning(
                "Lỗi", "Dữ liệu Pregnancies không phù hợp. Xin hãy nhập lại trong khoảng từ 0 đến 17")
            check = False
        ...
        if 0 < glucose < 50:
            ...
            messagebox.showwarning(
                "Lỗi", "Dữ liệu glucose không phù hợp. Xin hãy nhập lại trong khoảng từ 0 đến 199")
            check = False
        ...
        if 0 <= blood <= 40:
            ...
            messagebox.showwarning(
                "Lỗi", "Dữ liệu BloodPressure không phù hợp. Xin hãy nhập lại trong khoảng từ 0 đến 122")
            check = False
        ...
        if 0 <= skin <= 33:
            ...
            messagebox.showwarning(
                "Lỗi", "Dữ liệu skinThickness không phù hợp. Xin hãy nhập lại trong khoảng từ 0 đến 99")
            check = False
        ...
        if 0 <= insulin <= 211:
            ...
            messagebox.showwarning(
                "Lỗi", "Dữ liệu insulin không phù hợp. Xin hãy nhập lại trong khoảng từ 0 đến 846")
            check = False
        ...
        if 0 <= bmi <= 22.3:
            ...
            messagebox.showwarning(
                "Lỗi", "Dữ liệu bmi không phù hợp. Xin hãy nhập lại trong khoảng từ 0 đến 67")
            check = False
        ...
        if 0.078 <= diabetes <= 0.663:
            ...
            messagebox.showwarning(
                "Lỗi", "Dữ liệu diabetes  không phù hợp. Xin hãy nhập lại trong khoảng từ 0.078 đến 2.42")
            check = False
        ...
        if 0 < age <= 41:
            ...
            messagebox.showwarning(
                "Lỗi", "Dữ liệu age không phù hợp. Xin hãy nhập lại trong khoảng từ 0 đến 81")
            check = False
        if check:
            model = Diabetes()
            predict = model.predict(preg_range, glucose_range, blood_range,
                                    skin_range, insulin_range, bmi_range, diabetes_range, age_range)
            # txtResult = predict
            if (predict == 1):
